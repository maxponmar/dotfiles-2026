...
| Alacritty | `alacritty/alacritty.toml` | WSL: **copied** to Windows `%APPDATA%\alacritty\alacritty.toml`; native Linux: symlinked to `~/.config/alacritty/alacritty.toml` (skipped on macOS) |
